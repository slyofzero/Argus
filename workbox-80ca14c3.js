define(["exports"], (function(t) {
    ...
    function k(t) {
        return "function" == typeof t ? T(t) : (t instanceof IDBTransaction && function(t) {
            ...
            I.set(t, e)
        }(t), D(t, U || (U = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(t, O) : t)
    }
    ...
    class tt {
        constructor({
            ...
            this.A = new Map, this.F = new Map, this.H = new Map, this.u = new Z({
                cacheName: w(t),
                plugins: [...e, new J({
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {
                    cacheKey: t,
                    url: r
                } = G(n), i = "string" != typeof n && n.revision ? "reload" : "default";
